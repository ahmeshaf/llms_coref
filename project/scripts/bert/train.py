...
def train_centroid(
    ...
    for i in range(epochs):
        ...
        # cluster_embeddings = {clus_id: emb/torch.norm(embeddings, dim=0) for clus_id, emb in cluster_embeddings.items()}
        ...
        for i, m_id in tqdm(
            ...
            target_cluster_embedding = cluster_embeddings[target_cluster_id].reshape(
                (-1, 1)
            )
